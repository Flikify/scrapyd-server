...
SCRAPYD_USERNAME = os.environ.get('SCRAPYD_USERNAME', 'admin')
SCRAPYD_PASSWORD = os.environ.get('SCRAPYD_PASSWORD', 'password')
############################## QUICK SETUP start ##############################
############################## 快速设置 开始 ###################################
...
USERNAME = f'{SCRAPYD_USERNAME}'
PASSWORD = f'{SCRAPYD_PASSWORD}'
...
#   - e.g. ('', '', '127.0.0.1', '6800', '') or ('username', 'password', 'localhost', '6801', 'group')
SCRAPYD_SERVERS = [
    f'{SCRAPYD_USERNAME}:{SCRAPYD_PASSWORD}@localhost:6800#group',
...
SCRAPY_PROJECTS_DIR = '/app/scrapyd/project'
