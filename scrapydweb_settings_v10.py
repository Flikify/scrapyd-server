...
SCRAPYDWEB_USERNAME = os.environ.get('SCRAPYDWEB_USERNAME', 'admin')
SCRAPYDWEB_PASSWORD = os.environ.get('SCRAPYDWEB_PASSWORD', 'password')
############################## QUICK SETUP start ##############################
############################## 快速设置 开始 ###################################
...
USERNAME = f'{SCRAPYDWEB_USERNAME}'
PASSWORD = f'{SCRAPYDWEB_PASSWORD}'
...
#   - e.g. ('', '', '127.0.0.1', '6800', '') or ('username', 'password', 'localhost', '6801', 'group')
SCRAPYD_SERVERS = [
    f'{SCRAPYDWEB_USERNAME}:{SCRAPYDWEB_PASSWORD}@localhost:6800#group',
...
LOCAL_SCRAPYD_SERVER = f'{SCRAPYDWEB_USERNAME}:{SCRAPYDWEB_PASSWORD}@localhost:6800'
